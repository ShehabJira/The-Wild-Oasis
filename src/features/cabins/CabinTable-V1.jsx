...
function CabinTable() {
	...
	const { isLoading, data: cabins } = useQuery({
		...
		// this is function is responsible for querying(fetching the data from API). this function needs to return a promise, so use getCabins function which is async await which return a promise or fetch function as it returns a promise.
		queryFn: getCabins,
	});
